import { getInitialViewToSet, getUrlWithTimestampAndView } from "./view-utils.js";
...
it('should get url from timestamp and view', async () => {
    ...
    expect(getUrlWithTimestampAndView(timestamp, 1)).toEqual('/date/2020-01-01');
    expect(getUrlWithTimestampAndView(timestamp, 0)).toEqual('/utcDate/2020-01-01/utcTime/00:00');
});